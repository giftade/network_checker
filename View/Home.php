    ...
    <div id="accordion">
        ...
        <div class="card card-theme my-3" style="text-decoration:none">
            <div class="card-header" id="headingOne">
                <h5 class="mb-0">
                    <button class="btn btn-link collapsed mr-auto w-100  d-flex justify-content-between" data-toggle="collapse" data-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                        <p class="faq_header">
...
<script>
    $(document).ready(function() {
        ...
        $('#signalForm').submit(function(event) {
            ...
            // You can use 'selectedNetworkType' and 'selectedServiceProvider' here
            console.log('Selected Network Type:', selectedNetworkType);
            ...
            $.ajax({
                type: 'POST',
                url: '/search', // Replace 'test.php' with the URL of your PHP script
                data: {
